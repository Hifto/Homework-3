...
public class LevelGenerator : MonoBehaviour {
    ...
    //track how many pieces till next level
    private float nextLevelTrack = 0;
    ...
    public void NextLevel()
    {
        ...
        if (nextLevelTrack == 7)
        {
            ...
            //PlayerController.instance.runningSpeed = -1.5f;
            PlayerController.instance.transform.position = secondPos;
        }
    }
